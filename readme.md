...
- Created a **JSON data file** containing full names with WWE nicknames, emails, and Slack handles.  
- Used **fetch logic** to pull data dynamically from `data.json`.  
- Applied **console logging** to show full contact information (name, email, Slack) whenever a name is selected.  
